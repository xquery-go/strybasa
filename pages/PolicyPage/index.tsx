...
const PolicyPage = () => {
	return (
		<div className={styles.wrapper}>
			<title>
				Политика в отношении обработки персональных данных | Стройбаза Тиски
			</title>
			<Header />
			<div className={styles.content}>
				...
				<p className={styles.paragraph}>1. Общие положения</p>
				<p className={styles.paragraph}>
					...
					безопасности персональных данных, предпринимаемые ИП Поротову Артуру
					Владимировичу (далее — Оператор).
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					Оператор может получить о посетителях веб-сайта http://stroi-basa.ru.
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					сети интернет по сетевому адресу http://stroi-basa.ru.
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					2.10. Пользователь — любой посетитель веб-сайта http://stroi-basa.ru.
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>3.1. Оператор имеет право:</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>3.2. Оператор обязан:</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>Персональные данные</p>
				<p className={styles.paragraph}>фамилия, имя, отчество</p>
				<p className={styles.paragraph}>номера телефонов</p>
				<p className={styles.paragraph}>Правовые основания</p>
				<p className={styles.paragraph}>
					Федеральный закон «Об информации, информационных технологиях и о
					защите информации» от 27.07.2006 N 149-ФЗ
				</p>
				<p className={styles.paragraph}>Виды обработки персональных данных</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					направления Оператору уведомление на номер Оператора +79210800084 с
				...
				<p className={styles.paragraph}>
					...
					персональных данных, направив Оператору уведомление посредством номер
					Оператора +79210800084 с пометкой «Отзыв согласия на обработку
					персональных данных».
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>12. Заключительные положения</p>
				<p className={styles.paragraph}>
					...
					Оператору с помощью номер +79210800084.
				</p>
				<p className={styles.paragraph}>
				...
				<p className={styles.paragraph}>
					...
					сети Интернет по адресу http://stroi-basa.ru/policy.
				</p>
			</div>
			<Footer />
		</div>
