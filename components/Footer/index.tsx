        ...
        <div className={styles.container}>
            ...
            <div className={styles.block}>
                ...
                <div className={styles.contacts}>
                    <Link href={'#'}><Image src={'/img/WatsappYellow.svg'} width={30} height={30} alt={'Watsapp'}/></Link>
                    <Link href={'#'}><Image src={'/img/VkYellow.svg'} width={30} height={30} alt={'Vk'}/></Link>
                    <Link href={'#'}><Image src={'/img/PhoneYellow.svg'} width={30} height={30} alt={'Call Us'}/></Link>
                </div>
            </div>
        </div>
    )
